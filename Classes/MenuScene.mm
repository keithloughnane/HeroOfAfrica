...
{
	[[CCDirector sharedDirector] replaceScene: [CCFadeTransition transitionWithDuration:1 scene:[SettingsScene scene] withColor:ccWHITE]];
}

-(void) about:(id)sender
{
	[[CCDirector sharedDirector] replaceScene: [CCFlipYTransition transitionWithDuration:1 scene:[AboutScene scene]]];	
}
