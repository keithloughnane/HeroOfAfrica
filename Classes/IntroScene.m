...
-(id) init {
	if( (self=[super init])) {
		...
		[[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"herosprite.plist"];
		//NSLog(@"Adding testframes");
		[[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"testframes.plist"];
		//NSLog(@"Done adding testframes");
		[[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"platforms.plist"];
		
		//NSLog(@"setting enemy sheet .plist");
		[[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"enemyspritesheet.plist"];
