...
//
//Blue Diamond
@implementation Bluediamond

-(id) initWithBody:(b2Body*)body game:(GameNode*)game
{
	if( (self=[super initWithBody:body game:game]) ) {

		CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"bluediamond.png"];
...
-(void) touchedByHero
{
	[game_ increaseBDiamonds:1];
	[game_ increaseScore:240];
