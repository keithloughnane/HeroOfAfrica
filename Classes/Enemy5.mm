...
-(id) initWithBody:(b2Body*)body game:(GameNode*)game
{
	...
	if( (self=[super initWithBody:body game:game]) ) {
		...
		CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"walkingenemythird001.png"];
...
-(void) updateFrames
{
	...
	switch (behaveState) {
		case PATROLLEFT:
		{
			...
			//walk-left_02.png
			//running014.png
			NSString *str = [NSString stringWithFormat:@"walkingenemythird0%02d.png", x];
			CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:str];
			[self setDisplayFrame:frame];
		...
		case RUNLEFT:
		{
			...
			//walk-left_02.png
			//running014.png
			NSString *str = [NSString stringWithFormat:@"runenemythird0%02d.png", x];
			CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:str];
			[self setDisplayFrame:frame];
