...
-(id) initWithBody:(b2Body*)body game:(GameNode*)game
{
	...
	if( (self=[super initWithBody:body game:game]) ) {
		...
		CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"throwenemyfifth001.png"];
...
-(void) updateFramesUL
{
	...
	if(fireFrames >=10)
	{
	 ...
	 NSString *str = [NSString stringWithFormat:@"throwenemyfifth0%02d.png", (int)fireFrames];
	//NSLog(@">>%@",str);
	 CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:str];
	 [self setDisplayFrame:frame];
